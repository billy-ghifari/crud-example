...
<head>
    ...
    <title>@yield('title') | Billys Dev</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/dashboard" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Billys Dev</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2023 <a href="https://Billysdev.tech">Billys Dev</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
